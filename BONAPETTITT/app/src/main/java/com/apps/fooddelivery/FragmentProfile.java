...
public class FragmentProfile extends Fragment {
    ...
    TextView textView_name,textView_name_mid,textView_name_last, textView_email, textView_mobile, textView_notlog, textView_address;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView_name_mid = (TextView) rootView.findViewById(R.id.tv_prof_fname_mid);
        textView_name_last = (TextView) rootView.findViewById(R.id.tv_prof_fname_last);
    ...
    public void setVariables() {
        ...
        textView_name_mid.setText(Constant.itemUser.getNameMid());
        textView_name_last.setText(Constant.itemUser.getNameLast());

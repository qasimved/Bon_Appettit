...
public class LoadRegister extends AsyncTask<String,String,String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        String nameMid = strings[1];
        String nameLast = strings[2];
        ...
        nameValuePairs.add(new BasicNameValuePair("nameMid",nameMid));
        nameValuePairs.add(new BasicNameValuePair("nameLast",nameLast));
